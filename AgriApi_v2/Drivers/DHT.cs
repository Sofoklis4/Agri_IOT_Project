...
namespace AgriApi_v2.Drivers
{
    public class DHT
    {
       ...
       // private DHTSensorTypes _sensorType;
        ...
        private int _sensory;

       // private int _ReadReturn =-100;

        //private IGpioPin _dataPin;

        public DHT(int sensory)
        {
            //  if (datatPin != null)
            //  {
            ...
            _sensory = sensory;
            //Init the data pin
            Pi.Gpio[P1.Pin07].PinMode = GpioPinDriveMode.Output;
            Pi.Gpio[P1.Pin07].Write(GpioPinValue.High);
          //  }
          //  else
          //  {
        ...
        private int Read()
        {
            ...
            Pi.Gpio[P1.Pin07].Write(GpioPinValue.Low);
            ...
            Pi.Gpio[P1.Pin07].PinMode = GpioPinDriveMode.Input;
        ...
        private UInt32 ExpectPulse(GpioPinValue level)
        {
            ...
            while (Pi.Gpio[P1.Pin07].Read() == (level == GpioPinValue.High))
            {
                count++;
                //WaitMicroseconds(1);
                if (count == 10000)
